...
export const metadata = {
  title: "DiversyFund | Homepage (Previous Design)",
...
export default async function HomepageOldPage() {
  ...
  return <LandingPageOld content={content} testimonials={testimonialList} />;
}
