...
export default function Button({
  ...
  const mergedClassName = cn(base, styles, className);
  if (type === "submit") {
    return (
      <button type="submit" onClick={onClick} className={mergedClassName} {...props}>
        {children}
  ...
  if (type === "button") {
    return (
      <button type="button" onClick={onClick} className={mergedClassName} {...props}>
        {children}
        {showArrow && <ArrowRight className="h-4 w-4" />}
      </button>
    );
  ...
  return (
    <a href={href} onClick={onClick} className={mergedClassName} {...props}>
      {children}
      {showArrow && <ArrowRight className="h-4 w-4" />}
    </a>
  );
