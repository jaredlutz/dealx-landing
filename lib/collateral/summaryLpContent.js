...
export const SUMMARY_LP = {
  ...
  heroTitleBefore: "The DF Income",
  heroAccent: "summary",
  heroTitleAfter: " — offering overview for accredited investors.",
  heroUrgent: "Download the investor deck.",
  heroSupport:
    "Rate classes, structure, and strategy context — the same summary our team walks through on investor calls. Instant download; no form.",
