/**
 * Page content for /collateral/investment-thesis — teaser from the DF 2026 Fixed Income business plan.
 * Full detail lives in the downloadable document; this page drives one CTA: download.
 * Legacy path /collateral/business-plan redirects here.
 */
...
export const BUSINESS_PLAN_LP = {
  ...
  downloadFilename: "DiversyFund-DF-Income-Investment-Thesis.pdf",
  eyebrow: "",
  heroTitleBefore: "The",
  heroAccent: "investment thesis",
  heroTitleAfter: " for today's market.",
  heroUrgent: "",
  heroSupport:
