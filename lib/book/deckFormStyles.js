...
/** Two-column name rows — items-end keeps inputs aligned when labels wrap differently. */
export const deckFormFieldGridClass = "grid gap-4 sm:grid-cols-2 sm:items-end";
